class LRUCache {
    ...
    // Doubly linked starts with two dummynodes head and tail
    // insertion is always ahead of tail.
    class Node{
        int key;
        int value;
    ...
    public void put(int key, int value) {
        // preexisting, remove from list. modify put at tail
        // modify in hmap1 the node.
        if(hmap1.containsKey(key)){
