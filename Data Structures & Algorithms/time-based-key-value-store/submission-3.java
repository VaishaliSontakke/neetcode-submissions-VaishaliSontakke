...
class TimeMap {
    ...
    public void set(String key, String value, int timestamp) {
        ...
        Collections.sort(hmap1.get(key), Comparator.comparingInt(Pair::getSecond));
    }
    ...
    public String get(String key, int timestamp) {
        if(hmap1.containsKey(key)){
            ...
            if(index >= 0){
                ...
                int insertionP = -index-1;   // -4 insert at 0,1, 2, 3 <<< 3
                if (insertionP > 0){
                    return list1.get(insertionP -1).getFirst(); // lowest value that insertion is 3-1 = 2
                }
            }
        }
        return "";
